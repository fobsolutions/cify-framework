...
public class RecordMedia {
    ...
    public static boolean imagesToMedia(String imagesDir, int mediaFileDuration, String outputMediaDirectory, String outputMediaFile) {
        ...
        try {
            imageListToMediaFile(imagesDir, outputMediaDirectory + outputMediaFile, null, null, mediaFileDuration);
        } catch (Exception e) {
     ...
     */
    private static void imageListToMediaFile(String directory, String fileName, String formatName,
        ...
        System.out.println(MARKER + " Media frameRate " + frameRate);
        ...
        if (listOfFiles != null && listOfFiles.length > 0) {
            ...
            for (File listOfFile : listOfFiles) {
                if (listOfFile.isFile()) {
                    ...
                    BufferedImage bi = ImageIO.read(new File(directory + filename));
     ...
     */
    private static void setMediaDimensions(String directory) throws AWTException, InterruptedException, IOException {
        ...
        System.out.println(MARKER + " Source images count " + imagesCount);
    ...
    private static void setOutputMediaWidth(int outputMediaWidth) {
        RecordMedia.outputMediaWidth = outputMediaWidth;
    }
    ...
    private static void setOutputMediaHeight(int outputMediaHeight) {
        RecordMedia.outputMediaHeight = outputMediaHeight;
    }
}