 ...
 *
 * This class contains matchers implementation for MobileAndroidApp
 */

class MatchersMobileAndroidApp implements IMatchers {

    private Device device

    MatchersMobileAndroidApp(Device device) {
        this.device = device
    }
